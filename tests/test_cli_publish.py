...
from linebreak_gate.spec_bundle import dump_manifest_yaml
...
def test_payload_for_a_passing_run(tmp_path):
    ...
    assert body["criteria"] == [
        {"id": "S1-AC1", "story": "S1", "type": "build", "result": "pass", "detail": "d"},
        {"id": "S1-AC4", "story": "S1", "type": "manual", "result": "pass", "detail": "d"},
    ]
